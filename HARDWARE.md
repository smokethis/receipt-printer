...
- Add dtoverlay=fbtft,ili9486,bgr=1,speed=16000000,rotate=0,dc_pin=24,reset_pin=25,led_pin=18
...
- Pin 22 (RST) -> GPIO25
- Pin 11 (TP_IRQ) -> GPIO18

By default, the display will run porrait mode. 